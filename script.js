...
// Always start English — clear any stale saved language
localStorage.removeItem('ys-lang');
...
// Stats section removed — no counter needed
...
// Arabic is the default portfolio language.
localStorage.removeItem('ys-lang');
...
function restartTyped(lang) {
  ...
  const strings = lang === 'ar'
    ? ['واجهات برمجية آمنة', 'أنظمة باك إند', 'تكاملات ذكاء اصطناعي', 'تدريب فريلانس عملي']
    : ['Secure APIs', 'Backend Systems', 'AI Integrations', 'Freelance Growth'];
...
document.querySelectorAll('.js-tilt-glare').forEach(el => {
  el.style.borderRadius = '12px';
>>>>>>> 4087015 (Update Arabic portfolio content and projects)
});
